...
const SIZES: Record<Size, CSSProperties> = {
  sm: { height: "var(--control-h-sm)", padding: "0 16px", fontSize: "15px" },
  md: { height: "var(--control-h-md)", padding: "0 22px", fontSize: "17px" },
  lg: { height: "var(--control-h-lg)", padding: "0 30px", fontSize: "17px" },
};
...
export function Button(props: ButtonProps) {
  ...
  const skins: Record<Variant, CSSProperties> = {
    ...
    outlineInverse: { background: hover ? "rgba(255,255,255,.16)" : "rgba(255,255,255,.06)", color: "var(--white)", borderColor: "rgba(255,255,255,.45)" },
  };
