...
const eyebrowStyle = { fontFamily: "Archivo, Arial, sans-serif", fontWeight: 700, fontSize: 17, letterSpacing: ".14em", textTransform: "uppercase" as const, color: "#898989" };
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 18, paddingTop: 8 }}>
              ...
              <div style={cardStyle}>
                ...
                <ul style={{ margin: 0, padding: 0, listStyle: "none", display: "flex", flexDirection: "column", gap: 10 }}>
                  {ASK_FOR.map((item) => (
                    <li key={item} style={{ display: "flex", alignItems: "center", gap: 10, fontSize: 17, color: "#4d4d4d" }}>
              ...
              <div style={cardStyle}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
                  ...
                  <a href={PHONE_HREF} style={{ display: "inline-flex", alignItems: "center", gap: 8, fontWeight: 600, fontSize: 17, color: "var(--brand)", textDecoration: "none", borderBottom: 0 }}>
                    <Icon name="phone" size={16} strokeColor="var(--brand)" />
                    {PHONE_DISPLAY}
                  </a>
                </div>
                <p style={{ margin: 0, fontSize: 17, lineHeight: 1.55, color: "#4d4d4d" }}>The best way to get in touch is to fill out the form but if you have any questions or concerns you can call this number.</p>
              </div>
              <div style={{ ...cardStyle, gap: 16 }}>
                ...
                <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                  ...
                  <span style={{ fontSize: 17, lineHeight: 1.5, color: "#1c1c1c" }}>
                    {ADDRESS_LINE1}
                    <br />
                    {ADDRESS_LINE2}
                  </span>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <a href={PHONE_HREF} style={{ fontWeight: 600, fontSize: 17, color: "#1c1c1c", textDecoration: "none", borderBottom: 0 }}>
                    {PHONE_DISPLAY}
                  </a>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  <Icon name="mail" size={18} strokeColor="var(--brand)" style={{ flex: "0 0 auto" }} />
                  <a href={`mailto:${EMAIL}`} style={{ fontWeight: 600, fontSize: 17, color: "#1c1c1c", textDecoration: "none", borderBottom: 0, wordBreak: "break-all" }}>
                    {EMAIL}
                  </a>
                </div>
              </div>
        ...
        <div style={{ width: "96%", maxWidth: 1600, margin: "0 auto", background: "#f6f6f6", borderRadius: 16 }}>
          <div style={{ width: "89.6%", maxWidth: 1440, margin: "0 auto", padding: "clamp(48px,7vh,88px) 0" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 12, maxWidth: 720, marginBottom: "clamp(26px,4vh,42px)" }}>
              ...
              <p style={{ margin: 0, fontSize: 17, lineHeight: 1.6, color: "#4d4d4d" }}>If your question isn&apos;t here, call or email us and we will answer it directly.</p>
            </div>
            <div className="co-grid" style={cssVars({ "--cols": 3, "--cols-tablet": 2, "--cols-mobile": 1, "--gap-x": "40px", "--gap-y": "28px" })}>
              {CONTACT_FAQS.map((f) => (
                <div key={f.q} style={{ display: "flex", flexDirection: "column", gap: 8, minWidth: 0 }}>
                  ...
                  <span style={{ fontSize: 17, lineHeight: 1.6, color: "#4d4d4d" }}>{f.a}</span>
                </div>
              ))}
            </div>
          </div>
