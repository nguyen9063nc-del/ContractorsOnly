    ...
    <div>
      <section style={{ background: "#f6f6f6", borderBottom: "1px solid #e0e0e0", padding: "56px 0 48px" }}>
        <Container>
          ...
          <h1 style={{ margin: "18px 0 0", fontFamily: "Archivo, Arial, sans-serif", fontWeight: 700, fontSize: 40, lineHeight: 1.04, letterSpacing: "-.02em", color: "#1c1c1c", maxWidth: 760 }}>
            One team for everything your property needs.
          </h1>
          <p style={{ margin: "16px 0 0", fontSize: 20, lineHeight: 1.45, maxWidth: 620 }}>
        ...
        <Container>
          <div className="co-split" style={cssVars({ "--split-cols": ".42fr .58fr", "--split-gap": "64px" })}>
            <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
              <h2 style={{ margin: 0, fontFamily: "Archivo, Arial, sans-serif", fontWeight: 700, fontSize: 40, lineHeight: 1.04, letterSpacing: "-.01em", textTransform: "uppercase", color: "#1c1c1c" }}>Who we are</h2>
              <p style={{ margin: 0, fontSize: 17, lineHeight: 1.75, color: "#4d4d4d" }}>
        ...
        <Container>
          <div style={{ padding: "26px 0 50px" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <h2 style={{ margin: 0, fontFamily: "Archivo, Arial, sans-serif", fontWeight: 700, fontSize: 34, lineHeight: 1.18, letterSpacing: "-.01em", color: "#1c1c1c" }}>The people behind the work.</h2>
            </div>
            <div className="co-grid" style={{ ...cssVars({ "--cols": 5, "--cols-tablet": 3, "--cols-mobile": 2, "--gap-x": "24px", "--gap-y": "40px" }), marginTop: 44, justifyItems: "center" }}>
              {TEAM.map((p) => (
                <div key={p.name} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6, width: "100%", maxWidth: 250 }}>
                  ...
                  <span style={{ fontSize: 17, color: "#898989", textAlign: "center" }}>{p.role}</span>
                </div>
              ))}
            </div>
          </div>
